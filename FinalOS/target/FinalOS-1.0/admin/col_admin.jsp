...
<%@ page import="javax.security.auth.kerberos.EncryptionKey" %>
            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <button type="button" class="fa fa-plus-square btn btn-round btn-primary"
                            ...
                            <div class="x_content">
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><%=encrypt%></td>
                                        <td>
                                            <button type="button" class="fa fa-edit btn btn-round btn-primary"
                                                    data-toggle="modal" data-target=".bs-example-modal-sm"></button>
                                            <button type="button"
                                                    class="fa fa-bitbucket-square btn btn-round btn-danger"></button>
                                        </td>
