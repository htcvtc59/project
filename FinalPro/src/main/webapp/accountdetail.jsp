                ...
                <form>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputFrirstName">First Name</label>
                            <p id = "txtfirstname" class = "form-control"></p>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputLastname">Last Name</label>
                            <p id = "txtlastname" class = "form-control"></p>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <p id = "txtaddress" class = "form-control"></p>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                             <div class="row">
                                 <label  class="col-md-12">Account Balance </label>
