<%-- 
    Document   : products_doing
    Created on : Feb 7, 2018, 11:08:26 AM
    Author     : smart
--%>
            ...
            <div class="container">
                <div class="col-md-12 product-model-sec">
                    <div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
                        <span class="time-request" style="color: red;">Pending</span>
                        <span class="date-request">18:00 - 26/02/2018</span>
                        <div class="new-top">
